...
export function GitHubIcon({ w = 24, h = 24 }) {
  return (
    <svg
      className="icon icon-tabler icon-tabler-brand-github hover:animate-waving-hand"
      fill="none"
      height={h}
      stroke="currentColor"
      strokeLinecap="round"
...
export function LinkedInIcon({ w = 24, h = 24 }) {
  return (
    <svg
      className="icon icon-tabler icon-tabler-brand-linkedin hover:animate-waving-hand"
      fill="none"
      height={h}
      stroke="currentColor"
      strokeLinecap="round"
...
export function TwitterIcon({ w = 24, h = 24 }) {
  return (
    <svg
      className="icon icon-tabler icon-tabler-brand-x hover:animate-waving-hand"
      fill="none"
      height={h}
      stroke="currentColor"
      strokeLinecap="round"
